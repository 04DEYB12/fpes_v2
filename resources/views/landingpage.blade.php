        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg card-hover border-2 border-teal-500 relative overflow-hidden animate-pulse-slow">
                    <div class="absolute inset-0 bg-gradient-to-r from-teal-400/10 to-cyan-400/10 animate-gradient-shift"></div>
    ...
    <section id="about" class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative">
                    <div class="image-container aspect-square bg-gradient-to-br from-[#384862] to-[#483527] rounded-3xl shadow-2xl flex items-center justify-center relative">
